...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        self.autofocus_on.clicked.connect(self.start_autofocus)
        self.autofocus_off.clicked.connect(self.stop_autofocus)
    ...
    def autofocus(self):
        ...
        while (self.autofocus_enabled) and (e_diff < e_diff_threshold) and (energy < e_threshold):
