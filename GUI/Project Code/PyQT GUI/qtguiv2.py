...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1143, 856)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.centralwidget)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.img1_off = QtWidgets.QGroupBox(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.img1_off.sizePolicy().hasHeightForWidth())
        self.img1_off.setSizePolicy(sizePolicy)
        self.img1_off.setMinimumSize(QtCore.QSize(141, 781))
        self.img1_off.setTitle("")
        self.img1_off.setObjectName("img1_off")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.img1_off)
        self.verticalLayout.setObjectName("verticalLayout")
        self.cam1_on = QtWidgets.QPushButton(self.img1_off)
        self.cam1_on.setObjectName("cam1_on")
        self.verticalLayout.addWidget(self.cam1_on)
        self.cam1_off = QtWidgets.QPushButton(self.img1_off)
        self.cam1_off.setObjectName("cam1_off")
        self.verticalLayout.addWidget(self.cam1_off)
        self.cam1_bri_label = QtWidgets.QLabel(self.img1_off)
        ...
        self.cam1_bri_slider = QtWidgets.QSlider(self.img1_off)
        ...
        self.cam1_con_label = QtWidgets.QLabel(self.img1_off)
        ...
        self.cam1_con_slider = QtWidgets.QSlider(self.img1_off)
        ...
        self.img1_on = QtWidgets.QPushButton(self.img1_off)
        self.img1_on.setObjectName("img1_on")
        self.verticalLayout.addWidget(self.img1_on)
        self.pushButton = QtWidgets.QPushButton(self.img1_off)
        self.pushButton.setObjectName("pushButton")
        self.verticalLayout.addWidget(self.pushButton)
        self.img1_bri_label = QtWidgets.QLabel(self.img1_off)
        ...
        self.img1_bri_slider = QtWidgets.QSlider(self.img1_off)
        ...
        self.img1_con_label = QtWidgets.QLabel(self.img1_off)
        ...
        self.img1_con_slider = QtWidgets.QSlider(self.img1_off)
        ...
        self.Right_Widgets.setTitle("")
        self.Right_Widgets.setObjectName("Right_Widgets")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.Right_Widgets)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.cam2_on = QtWidgets.QPushButton(self.Right_Widgets)
        self.cam2_on.setObjectName("cam2_on")
        self.verticalLayout_2.addWidget(self.cam2_on)
        self.cam2_off = QtWidgets.QPushButton(self.Right_Widgets)
        self.cam2_off.setObjectName("cam2_off")
        self.verticalLayout_2.addWidget(self.cam2_off)
        ...
        self.img2_on = QtWidgets.QPushButton(self.Right_Widgets)
        self.img2_on.setObjectName("img2_on")
        self.verticalLayout_2.addWidget(self.img2_on)
        self.pushButton_2 = QtWidgets.QPushButton(self.Right_Widgets)
        ...
        self.img2_denoise = QtWidgets.QPushButton(self.Right_Widgets)
        self.img2_denoise.setObjectName("img2_denoise")
        self.verticalLayout_2.addWidget(self.img2_denoise)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cam1_bri_label.setText(_translate("MainWindow", "Cam 1 Brightness"))
        self.cam1_con_label.setText(_translate("MainWindow", "Cam 1 Contrast"))
        self.img1_on.setText(_translate("MainWindow", "Image - Cam 1"))
        self.pushButton.setText(_translate("MainWindow", "Clear Image"))
        self.img1_bri_label.setText(_translate("MainWindow", "Image 1 Brightness"))
        self.img1_con_label.setText(_translate("MainWindow", "Image 1 Contrast"))
        ...
        self.cam2_bri_label.setText(_translate("MainWindow", "Cam 2 Brightness"))
        self.cam2_con_label.setText(_translate("MainWindow", "Cam 2 Contrast"))
        self.img2_on.setText(_translate("MainWindow", "Image - Cam 2"))
        self.pushButton_2.setText(_translate("MainWindow", "Clear Image"))
        self.im2_bri_label.setText(_translate("MainWindow", "Image 2 Brightness"))
        self.img2_con_label.setText(_translate("MainWindow", "Image 2 Contrast"))
        self.img2_denoise.setText(_translate("MainWindow", "Denoise Image 2"))
