#Import Modules 
#Attempt to fix camera issue - queue method - remove colour correction too!
import sys
import cv2
import numpy as np
import threading
...
class CSI_Camera(QThread):
    ...
    def __init__(self):
        ...
        self.frame_queue = queue.Queue() # Create a queue to store frames
    ...
    def run(self):
        while self.running:
            try:
                ...
                if grabbed:
                    # Enqueue the frame to the queue
